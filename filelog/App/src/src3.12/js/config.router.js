    ...
    ['$stateProvider', '$urlRouterProvider', 'JQ_CONFIG',
      function ($stateProvider, $urlRouterProvider, JQ_CONFIG) {
          ...
          $stateProvider
            ...
            .state('app.filejoblog', {
                url: '/filejoblog',
                templateUrl: 'splus/filejoblog.html'
            })

       .state('app.charttpl', {
           url: '/charttemp/{fold}',
           templateUrl: 'splus/charttpl.html',
           resolve: {
               deps: ['uiLoad',
                 function (uiLoad) {
        ...
        .state('app.filejoblogsetting', {
              url: '/setting',
              templateUrl: 'splus/filejoblog_setting.html',
              resolve: {
                  deps: ['$ocLazyLoad',
                    function ($ocLazyLoad) {
            ...
            //  .state('app.page', {
             ...
             // })
              //这个路由总是会被第一个匹配中而无法匹配自身
              // .state('app.filejoblog.profiles', {
              //     url: '/profiles',
             //      templateUrl: 'splus/filejoblog_setting.html'
            //   })
